        ...
        <header className="fixed left-0 right-0 top-0 z-50 h-20 border-b border-gray-200 bg-white">
          <div className="flex h-full items-center justify-between px-8">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-lg font-bold text-gray-900">Keuanganku</h1>
                <p className="text-xs text-gray-500">Kelola keuangan dengan mudah</p>
              </div>
            </div>

            <div className="flex items-center gap-3">
              <div className="hidden text-right sm:block">
                <p className="text-sm font-semibold text-gray-900">Elza</p>
          ...
          <div className="flex h-full flex-col p-5">
            <div>
              ...
              <nav className="space-y-1">
                <Link href="/" className="flex items-center gap-3 rounded-xl bg-[#7f1d1d] px-4 py-3 text-sm font-semibold text-white">
                  <span className="text-lg">⌂</span>
                  Dashboard
                </Link>
                <Link href="/transaksi" className="flex items-center gap-3 rounded-xl px-4 py-3 text-sm font-medium text-gray-600 transition hover:bg-[#f8eeee] hover:text-[#7f1d1d]">
                  <span className="text-lg">＋</span>
                  Transaksi
                </Link>
                <Link href="/riwayat" className="flex items-center gap-3 rounded-xl px-4 py-3 text-sm font-medium text-gray-600 transition hover:bg-[#f8eeee] hover:text-[#7f1d1d]">
                  <span className="text-lg">▤</span>
                  Riwayat
                </Link>
                <Link href="/profil" className="flex items-center gap-3 rounded-xl px-4 py-3 text-sm font-medium text-gray-600 transition hover:bg-[#f8eeee] hover:text-[#7f1d1d]">
                  <span className="text-lg">◯</span>
                  Profil
                </Link>
              </nav>
            ...
            <div className="mt-auto">
              <div className="rounded-2xl bg-[#f8eeee] p-4">
                <p className="text-sm font-semibold text-[#7f1d1d]">Kelola keuanganmu</p>
